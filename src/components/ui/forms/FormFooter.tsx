    ...
    <div className="flex gap-3 w-full">
      {onCancel && (
        <button
          ...
          onClick={onCancel}
          disabled={loading}
          className="flex-1 h-[56px] rounded-[16px] text-[15px] font-semibold bg-white/5 text-white/70 hover:bg-white/10 active:scale-[0.98] transition-all disabled:opacity-50 border border-white/[0.06]"
        >
          {cancelLabel}
        </button>
      )}
