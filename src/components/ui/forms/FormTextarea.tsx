    ...
    return (
      <div className="space-y-1">
        ...
        <textarea
          ...
          ref={resolvedRef}
          className={cn(
            'flex w-full rounded-[16px] border px-4 py-3.5 text-[15px] text-white placeholder:text-white/25 transition-all duration-200 bg-[#1E2235]/80 resize-none min-h-[56px] leading-relaxed',
