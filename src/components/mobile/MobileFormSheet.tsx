        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
          <DialogContent className="sm:max-w-[640px] max-h-[90vh] flex flex-col p-0 gap-0 overflow-hidden">
            <DialogHeader className="shrink-0 flex flex-row items-center justify-between gap-4 px-6 py-4 border-b">
              ...
              <button
                onClick={() => onOpenChange(false)}
                className="touch-target flex h-9 w-9 items-center justify-center rounded-lg text-muted-foreground hover:bg-accent/50 hover:text-foreground transition-all shrink-0"
              >
                <X className="h-4 w-4" />
              </button>
            </DialogHeader>
