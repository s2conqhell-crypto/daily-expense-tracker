...
export function MobileBalanceCard({ currentBalance, totalIncome, totalExpenses, savings, currency, loading }: MobileBalanceCardProps) {
  return (
    <div className="relative overflow-hidden rounded-[24px] gradient-balance px-6 py-6 shadow-2xl" style={{ boxShadow: '0 12px 48px rgba(107, 79, 245, 0.25), 0 4px 16px rgba(0, 0, 0, 0.15)' }}>
      ...
      <div className="relative z-10">
        ...
        {loading ? (
          ...
          <p className="num-xl text-white mb-3 tracking-tight">
