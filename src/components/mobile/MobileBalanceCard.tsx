...
export const MobileBalanceCard = memo(function MobileBalanceCard({ currentBalance, totalIncome, totalExpenses, savings, currency, loading }: MobileBalanceCardProps) {
  return (
